...
export default function PokeCard(props) {
    ...
    useEffect(() => {
        ...
        // we passed all the cache stuff to no avail and now need to fetch the data 
    

        // we passed all the cache to no avail and now need to fetch the data from the API
    ...
    <div className='poke-card'> 
        ...
        <div className='img-container'>
            {imgList.map((spriteUrl, spriteIndex) => {
                ...
                return (
                    <img key={spriteIndex} src={imgUrl} alt={'${name}-img-${spriteIndex}'} />
                )   
            })}             
        </div>
        <h3>Stats</h3>
